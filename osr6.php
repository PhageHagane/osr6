...
<main class="main">
      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="hero-content">
            <h1>Online Slingshot Region 6 <span>2025</span></h1>
            <p>WESTERN VISAYAS DIGITAL CREATIVES CONFERENCE</p>
            <div class="hero-actions justify-content-center justify-content-lg-start">
              <a href="zoom-registration.php" class="btn-primary scrollto">Register Now</a>
              <!-- <a href="https://youtu.be/p_Gv4ZRzUp0?si=bS3olm_VYID3KMMC"
                class="glightbox btn-video d-flex align-items-center">
        ...
        <div class="col-lg-6">
          <div class="hero-image">
            <img src="assets/img/illustration/mulave_mascot.png" class="img-fluid floating" alt="">
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="clients" class="clients section">
    ...
    <div class="container">
      ...
      <div class="swiper init-swiper">
        ...
        <?php
        function getClientImages($directory = 'assets/img/clients/')
        {
          $images = [];
        ...
        $dynamic_clients = getClientImages();
        ?>

        <!-- Auto-scanning Version -->
        <div class="swiper-wrapper align-items-center">
          <?php foreach ($dynamic_clients as $client): ?>
            <div class="swiper-slide">
              <img src="assets/img/clients/<?php echo htmlspecialchars($client); ?>" class="img-fluid" alt="">
            </div>
          <?php endforeach; ?>
        </div>
      </div>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6">
          <div class="content">
            ...
            <div class="stats-row">
              <div class="stat-item">
                <h3><span data-purecounter-start="0" data-purecounter-end="150" data-purecounter-duration="1"
                    class="purecounter"></span>+</h3>
                <p>Projects Completed</p>
              </div>
              <div class="stat-item">
                <h3><span data-purecounter-start="0" data-purecounter-end="12" data-purecounter-duration="1"
                    class="purecounter"></span>+</h3>
    ...
    <div class="container">
      ...
      <div class="features-grid">
        ...
        <div class="features-card">
          ...
          <p>
            Quisque velit nisi, pretium ut lacinia in, elementum id enim. Mauris blandit aliquet elit, eget tincidunt
            nibh pulvinar.
          </p>
          <div class="features-list">
            <div class="feature-item">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6">
            <div class="step-item">
              ...
              <h3>Discovery</h3>
              <p>Understanding your business goals and requirements through in-depth analysis and consultation sessions.
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="step-item">
              ...
              <h3>Planning</h3>
              <p>Creating detailed project roadmaps and strategies aligned with your objectives and timeline
                requirements.</p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="step-item">
              ...
              <h3>Execution</h3>
              <p>Implementing solutions with precision while maintaining transparent communication throughout the
                process.</p>
            </div>
          </div>
  ...
  <!-- Tabs Section -->
  <section id="tabs" class="tabs section" hidden>
            ...
            <div class="row align-items-center">
              <div class="col-lg-6">
                <div class="content-area">
                  ...
                  <p>Sed ut perspiciatis unde omnis natus error sit voluptatem accusantium doloremque laudantium, totam
              ...
              <div class="col-lg-6">
                <div class="content-area">
                  ...
                  <p>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet
                    voluptates repudiandae sint et molestiae non recusandae itaque earum rerum hic tenetur sapiente
                    delectus.</p>
            ...
            <div class="row align-items-center">
              <div class="col-lg-6">
                <div class="content-area">
                  ...
                  <p>Eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus omnis voluptas
                    assumenda est omnis dolor repellendus temporibus autem quibusdam et aut officiis debitis.</p>
            ...
            <div class="testimonial-item">
              ...
              <div class="testimonial-body">
                <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est
                  laborum consectetur adipiscing elit sed eiusmod tempor.</p>
              </div>
